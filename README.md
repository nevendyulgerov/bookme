...
<sub><sup>Disclaimer: The application code and unit tests were written manually by Neven Dyulgerov. The e2e tests and this README file were generated by Claude and subsequently evaluated and proof-read by Neven Dyulgerov.</sup></sub>
